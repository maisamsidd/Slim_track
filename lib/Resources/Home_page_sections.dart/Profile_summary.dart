                  ...
                  children: [
                    ...
                    Container(
                      ...
                      const SizedBox(width: 10,),
                       ...
                       Column(
                        children: [
                          const Text("Welcome, Maisam!",style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                          const Text("You are on your way to a good start",style: TextStyle(fontSize: 16,),),
