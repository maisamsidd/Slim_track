                ...
                child: Column(children: [
                  Row(
                    ...
                    children: [
                      ...
                      const Center(child: Text("Monthly Plan", style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold),)),
                  ...
                  Container(
                    ...
                    child: const Center(child: Text("\$125",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)),
                  ),
