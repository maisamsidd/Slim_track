...
class _SecretGemState extends State<SecretGem> {
  ...
  Future<void> _getDataLength() async {
    ...
    final fireStore = FirebaseFirestore.instance.collection("routine_foods").doc(userId).collection("data");
