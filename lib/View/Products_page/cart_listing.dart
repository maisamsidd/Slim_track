                    ...
                    itemBuilder: (context, index) {
                      ...
                      void increaseQuantity(int quantity, double price) async {
                        ...
                        if (docSnapshot.exists) {
                          await docRef.update({'bags': quantity + 1, 'price': price * 2});
                        } else {
                          Get.snackbar(
                            "Error",
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          width: 110,
                                          height: 110,
                                          child: Image.asset(cartItem.image.toString()),
                                        ),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 15),
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                children: [
                                                  GestureDetector(
                                                    onTap: () async {
                                                      decreaseQuantity(cartItem.quantity!, cartItem.price!);
                                                    },
                                                    child: const Icon(
                                                  ...
                                                  GestureDetector(
                                                    onTap: () async {
                                                      increaseQuantity(cartItem.quantity!, cartItem.price!);
                                                    },
                                                    child: const Icon(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("\$${subtotal.toStringAsFixed(2)}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("\$${tax.toStringAsFixed(2)}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text("Shipping:", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                            Text("\$${shippingFee.toStringAsFixed(2)}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            const Text("Total:", style: TextStyle(fontSize: 23, fontWeight: FontWeight.bold)),
                            Text("\$${total.toStringAsFixed(2)}", style: const TextStyle(fontSize: 23, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      MyAnimatedButton(
